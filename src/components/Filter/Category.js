...
const CategoryFilterComponent = observer(({store}) => {
  const {filterButton, expandIcon, formControlLabel, formGroup, buttonClear, buttonConfirm} = useStyles();
          ...
          <FormGroup className={formGroup}>
            ...
            <div>
                <button className={buttonClear} onClick={()=>{
                  ...
                  store.changeValue('categoryFilters',{})}}>Clear</button>
