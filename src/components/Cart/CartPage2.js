...
export const CartPage = observer(({userStore}) => <CartPageComponent userStore={userStore} cartItemNumberStore={cartItemNumberStore} />)

export const CartPageComponent = ({userStore, cartItemNumberStore}) => {
  ...
  console.log(cartItemsNumber, 'how many items in cart?');
  ...
  console.log(cartItemNumberStore.cartItemNumber, 'number in store');
